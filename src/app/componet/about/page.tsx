...
// import { Sparkles, Mail, History } from "lucide-react";
...
//           About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">MailMorph</span>
//         </h2>
//         <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
//           MailMorph is your AI-powered email assistant that helps you write, send, and manage professional emails effortlessly. 
//           It combines the simplicity of Gmail with the intelligence of AI to boost your productivity.
//         </p>
...
//               Generate professional and engaging email content instantly with our AI engine.
//             </p>
//           </div>
...
//             </div>
//             <h3 className="text-xl font-semibold text-gray-900 mb-2">Smart Email Sending</h3>
//             <p className="text-gray-600 text-sm">
//               Send your AI-generated emails directly from the platform with real-time delivery.
//             </p>
//           </div>
...
//             </div>
//             <h3 className="text-xl font-semibold text-gray-900 mb-2">Email History</h3>
//             <p className="text-gray-600 text-sm">
//               Keep track of all sent emails in one place, with easy search and filter options.
//             </p>
//           </div>
//         </div>
//       </div>
...
//           MailMorph is your AI-powered email assistant that helps you write, send, 
//           and manage professional emails effortlessly. It combines the simplicity 
//           of Gmail with the intelligence of AI to boost your productivity.
//         </p>

//         {/* Features Grid */}
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
//           {/* Feature 1 */}
//           <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/10 shadow-xl hover:shadow-cyan-500/40 transition transform hover:-translate-y-2 animate-fadeIn delay-400">
//             <div className="flex justify-center mb-4">
...
//           {/* Feature 2 */}
//           <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/10 shadow-xl hover:shadow-purple-500/40 transition transform hover:-translate-y-2 animate-fadeIn delay-600">
//             <div className="flex justify-center mb-4">
...
//           {/* Feature 3 */}
//           <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/10 shadow-xl hover:shadow-pink-500/40 transition transform hover:-translate-y-2 animate-fadeIn delay-800">
//             <div className="flex justify-center mb-4">
//               <History className="text-pink-400 drop-shadow-glow" size={42} />
//             </div>
//             <h3 className="text-xl font-semibold text-white mb-2">
//               Email History
//             </h3>
