...
//   const handleLogin = () => window.open(`${API_BASE}/auth/login`, "_blank");
...
//           <span className="bg-gradient-to-r from-cyan-400 to-purple-500 text-white font-bold text-lg px-2 py-1 rounded">
//             AI
//           </span>
...
//           {user ? (
//             <>
//               <span className="px-3 py-1 rounded-full bg-white/10 text-cyan-300 font-medium">
//                 Hi, {user.name}
//               </span>
//               <button
//                 onClick={handleLogout}
//                 className="px-4 py-2 rounded-lg border border-red-400 text-red-400 hover:bg-red-500/20 transition"
//               >
//                 Logout
//               </button>
//             </>
...
//       {/* Mobile menu */}
//       {isOpen && (
//         <div className="md:hidden bg-black/90 backdrop-blur-md border-t border-white/10 shadow-xl">
//           <ul className="flex flex-col gap-4 p-6">
//             {menuItems.map((item) => (
//               <li key={item.name}>
//                 <a href={item.href} className="block text-gray-200 hover:text-white font-medium">{item.name}</a>
//               </li>
//             ))}
//             <hr className="my-2 border-gray-700" />
//             {user ? (
//               <>
//                 <span className="block text-gray-300 bg-white/10 px-3 py-1 rounded-full mb-2">Hi, {user.name}</span>
//                 <button
//                   onClick={handleLogout}
//                   className="w-full px-4 py-2 rounded-lg border border-red-400 text-red-400 hover:bg-red-500/20 transition text-center"
//                 >
//                   Logout
//                 </button>
//               </>
...
//                 <button
//                   onClick={handleLogin}
//                   className="w-full px-4 py-2 rounded-lg border border-cyan-400 text-cyan-300 hover:bg-cyan-500/20 transition text-center"
//                 >
//                   Login with Gmail
//                 </button>
//                 <a
...
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="w-full px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-700 text-white hover:opacity-90 transition text-center mt-2"
//                 >
//                   Sign Up
//                 </a>
//               </>
...
//     ? [...baseMenuItems, { name: "Dashboard", href: "/componet/dasboard" }]
//     : baseMenuItems;
...
//     // Check if popup closed → fetch user
//     const checkLogin = setInterval(() => {
//       if (loginWindow?.closed) {
//         clearInterval(checkLogin);
//         fetchUser(); // 🔥 Fetch fresh profile
//       }
//     }, 1000);
//   };

//   // ✅ Logout but keep localStorage safe
//   const handleLogout = async () => {
//     try {
...
//       if (res.ok) {
//         setUser(null);
//         // ⚠️ localStorage.removeItem("user") hata diya
//       }
//     } catch {}
//   };

//   // ✅ Save profile edit locally
...
//                           setTempPic(user.profilePic || null);
//                         }}
